  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <img onClick={()=>fileRef.current.click()} src={formData.avatar || currentUser.avatar} alt="profile avatar" 
      ...
      </p>
      {
        ...
        userListings.map((listing) => (
           <div key={listing._id} className="border round-lg p-3 flex justify-between items-center gap-4">
